...
public class ReviewController {
    ...
    public ReviewDto findReview(@PathVariable("reviewId") @Positive Long reviewId) {
    ...
    public void removeReview(@PathVariable("reviewId") @Positive Long reviewId) {
    ...
    @ResponseStatus(HttpStatus.OK)
    public void likeIt(@PathVariable("reviewId") @Positive Long reviewId,
    ...
    @ResponseStatus(HttpStatus.OK)
    public void dislikeIt(@PathVariable("reviewId") @Positive Long reviewId,
                          @PathVariable("userId") @Positive Long userId) {
    ...
    @ResponseStatus(HttpStatus.OK)
    public void removeLike(@PathVariable("reviewId") @Positive Long reviewId,
                           @PathVariable("userId") @Positive Long userId) {
    ...
    @ResponseStatus(HttpStatus.OK)
    public void removeDislike(@PathVariable("reviewId") @Positive Long reviewId,
                              @PathVariable("userId") @Positive Long userId) {
